...
const Appointments = () => {
  return (
    <section className="text-white body-font bg-green-900">
          ...
          <div className="py-8 px-4 lg:w-1/3">
            <div className="h-full flex items-start">
              <div className="w-12 flex-shrink-0 flex flex-col text-center leading-none">
                ...
                <span className="font-medium text-lg text-white title-font leading-none">18</span>
              </div>
              <div className="flex-grow pl-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-indigo-300 mb-1">CATEGORY</h2>
