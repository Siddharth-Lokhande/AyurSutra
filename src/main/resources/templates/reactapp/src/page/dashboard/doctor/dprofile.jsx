      ...
      <div className="bg-yellow-800 rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                <option value="MD (Ayurveda)">Doctor of Medicine in Ayurveda</option>
                <option value="MS (Ayurveda)">Master of Surgery in Ayurveda</option>
                <option value="PhD (Ayurveda)">Doctor of Philosophy in Ayurveda</option>
                <option value="Ayurvedacharya">Ayurvedacharya</option>
                <option value="DAMS">Diploma in Ayurvedic Medicine and Surgery (DAMS)</option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Expertise in Field */}
            <div>
              <label htmlFor="expertise" className="block text-sm font-medium mb-1">Expertise in Field</label>
              <input
                type="text"
                id="expertise"
                name="expertise"
